    ...
    return (
        <div className='home_tip_page'>
            <div className='tip_con'>
                ...
                <img src={BalconyTip1}  alt="img lost" />
                <h4>一、阳台怎么装修</h4>
                ...
                <img src={BalconyTip2} alt="img lost" />
                ...
                <img src={BalconyTip3} alt="img lost" />
                ...
                <img src={BalconyTip4} alt="img lost" />
                <img src={BalconyTip5}  alt="img lost"/>
                ...
                <img src={BalconyTip6}  alt="img lost"/>
                <span><strong>②封闭式</strong></span>
